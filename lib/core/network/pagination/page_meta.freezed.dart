...
mixin _$PageMeta {
 ...
 int get page; int get pageSize; int get totalCount; int get totalPages; bool get hasNext;
...
@override
int get hashCode => Object.hash(runtimeType,page,pageSize,totalCount,totalPages,hasNext);

@override
String toString() {
  return 'PageMeta(page: $page, pageSize: $pageSize, totalCount: $totalCount, totalPages: $totalPages, hasNext: $hasNext)';
}
...
@useResult
$Res call({
 int page, int pageSize, int totalCount, int totalPages, bool hasNext
});
...
/// Create a copy of PageMeta
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? page = null,Object? pageSize = null,Object? totalCount = null,Object? totalPages = null,Object? hasNext = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int page,  int pageSize,  int totalCount,  int totalPages,  bool hasNext)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PageMeta() when $default != null:
return $default(_that.page,_that.pageSize,_that.totalCount,_that.totalPages,_that.hasNext);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int page,  int pageSize,  int totalCount,  int totalPages,  bool hasNext)  $default,) {final _that = this;
switch (_that) {
case _PageMeta():
return $default(_that.page,_that.pageSize,_that.totalCount,_that.totalPages,_that.hasNext);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int page,  int pageSize,  int totalCount,  int totalPages,  bool hasNext)?  $default,) {final _that = this;
switch (_that) {
case _PageMeta() when $default != null:
return $default(_that.page,_that.pageSize,_that.totalCount,_that.totalPages,_that.hasNext);case _:
  return null;
...
class _PageMeta implements PageMeta {
  const _PageMeta({required this.page, required this.pageSize, required this.totalCount, required this.totalPages, required this.hasNext});
...
/// Create a copy of PageMeta
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? page = null,Object? pageSize = null,Object? totalCount = null,Object? totalPages = null,Object? hasNext = null,}) {
